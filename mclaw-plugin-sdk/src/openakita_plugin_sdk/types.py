...
type hints without importing the full Mclaw package.
"""
...
class UnifiedMessage:
    ...
    Mirrors ``mclaw.channels.types.UnifiedMessage`` for type hints.
...
class OutgoingMessage:
    ...
    Mirrors ``mclaw.channels.models.OutgoingMessage`` for type hints.
    """
