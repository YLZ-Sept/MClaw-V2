...
Or from the command line::
    ...
    python -m mclaw_plugin_sdk.scaffold --id my-plugin --type tool --dir ./my-plugin
"""
 ...
 * Mclaw Plugin UI Bootstrap (zero-dependency, ~3KB)
 *
 ...
 * helper API at window.Mclaw for plugin code to use.
 *
...
(function () {
  ...
  if (window.Mclaw && window.Mclaw.__bootstrapped) return;
  ...
  window.addEventListener("message", function (event) {
    ...
    switch (d.type) {
      ...
      case "bridge:handshake-ack": {
        ...
        if (!window.Mclaw.__ready) {
          window.Mclaw.__ready = true;
          dispatch("mclaw:ready", Object.assign({}, meta));
        }
        break;
      }
      case "bridge:theme-change": {
        ...
        meta.theme = t;
        applyTheme(t);
        dispatch("mclaw:theme-change", { theme: t });
        break;
      }
      case "bridge:locale-change": {
        var l = (d.payload && d.payload.locale) || "zh-CN";
        meta.locale = l;
        dispatch("mclaw:locale-change", { locale: l });
        break;
      }
      case "bridge:event": {
        dispatch("mclaw:event", d.payload || {});
        break;
      }
  ...
  window.Mclaw = {
    ...
    onReady: function (cb) {
      if (window.Mclaw.__ready) {
        ...
        window.addEventListener("mclaw:ready", function (e) { cb(e.detail); }, { once: true });
      }
    },
    ready: function () {
...
PLUGIN_TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "channel": {
        ...
        "category": "channel",
        "code": textwrap.dedent('''\
            """Example channel plugin for Mclaw."""
    ...
    "rag": {
        ...
        "category": "knowledge",
        "code": textwrap.dedent('''\
            """Example RAG plugin for Mclaw."""

            from __future__ import annotations

            from mclaw_plugin_sdk import PluginBase, PluginAPI, RetrievalSource
            from mclaw_plugin_sdk.tools import tool_definition
    ...
    "memory": {
        ...
        "category": "memory",
        "code": textwrap.dedent('''\
            """Example memory backend plugin for Mclaw."""
    ...
    "llm": {
        ...
        "category": "ai",
        "code": textwrap.dedent('''\
            """Example LLM provider plugin for Mclaw."""
    ...
    "ui": {
        ...
        "code": textwrap.dedent('''\
            """Example full-stack UI plugin for Mclaw (Plugin 2.0)."""
        ...
        "html": textwrap.dedent("""\
            ...
            <body>
              ...
              <script>
                ...
                window.Mclaw.onReady(function () {
                  window.Mclaw.api('GET', 'status').then(function (resp) {
...
def scaffold_plugin(
    ...
    manifest: dict[str, Any] = {
        ...
        "name": plugin_name,
        "version": version,
        "description": description or f"A {plugin_type} plugin for Mclaw",
        "author": author,
        "license": "MIT",
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Scaffold an Mclaw plugin")
