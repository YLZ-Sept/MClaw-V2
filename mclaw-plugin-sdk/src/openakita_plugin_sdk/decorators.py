...
def tool(
    ...
    def decorator(fn: Callable) -> Callable:
        fn.__mclaw_tool__ = defn  # type: ignore[attr-defined]
...
def hook(hook_name: str) -> Callable:
    ...
    def decorator(fn: Callable) -> Callable:
        fn.__mclaw_hook__ = hook_name  # type: ignore[attr-defined]
