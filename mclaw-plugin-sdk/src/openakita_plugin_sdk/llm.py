...
class LLMSelectionPolicy(StrEnum):
    """How a plugin completion chooses an Mclaw endpoint."""
...
class PluginLLM(Protocol):
    """Stable, read-only facade over Mclaw's configured LLM endpoints.
...
class LLMProvider(ABC):
    ...
    Mirrors ``mclaw.llm.providers.base.LLMProvider`` so plugin authors
