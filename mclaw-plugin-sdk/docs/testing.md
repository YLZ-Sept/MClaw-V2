...
SDK 提供测试工具，让你无需运行完整的 Mclaw 实例即可验证插件的正确性。

The SDK provides testing utilities to verify your plugin without a running Mclaw instance.
...
```python
from mclaw_plugin_sdk import LLMModel
from mclaw_plugin_sdk.testing import MockPluginAPI, MockPluginLLM
...
```python
from mclaw_plugin_sdk.testing import MockPluginAPI
...
```python
from mclaw_plugin_sdk.testing import assert_plugin_loads
from plugin import Plugin
...
```python
from mclaw_plugin_sdk.decorators import clear_registries
