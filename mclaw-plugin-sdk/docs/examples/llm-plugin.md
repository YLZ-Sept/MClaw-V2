...
注册一个新的 LLM 提供商，让 Mclaw 支持新的大模型 API（如 Ollama、自建模型服务等）。

Registers a new LLM provider, enabling Mclaw to support new model APIs (e.g., Ollama, self-hosted models).
