...
|-------------|:---:|-------------------|
| `mclaw` | 是 (error) | 最低 Mclaw 版本，格式 `>=X.Y.Z` / Minimum Mclaw version |
...
```json
{
  ...
  "author": "Community",
  "license": "MIT",
  "homepage": "https://github.com/mclaw/plugin-obsidian-kb",
  "type": "python",
  "entry": "plugin.py",
  "permissions": [
    "tools.register",
...
- `requires.mclaw` 版本不兼容 → 跳过 / Incompatible version → skip
