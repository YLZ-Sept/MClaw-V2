...
mclaw.relay.apply_relay_override helper underneath but each
...
# ─── Fake mclaw.relay module so tests do not depend on PYTHONPATH ──
...
def test_mclaw_relay_import_failure_falls_back(monkeypatch):
