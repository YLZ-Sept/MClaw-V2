...
# When the SDK lives next to Mclaw as a sibling checkout, expose it.
_SDK_SRC = _PLUGIN_ROOT.parents[1] / "mclaw-plugin-sdk" / "src"
if _SDK_SRC.is_dir() and str(_SDK_SRC) not in sys.path:
    sys.path.insert(0, str(_SDK_SRC))

from mclaw_plugin_sdk.testing import MockPluginAPI  # noqa: E402
