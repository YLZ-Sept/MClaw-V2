"""DashScope Paraformer ASR plus Mclaw Plugin LLM analysis.
...
class ClipAsrClient:
    """DashScope Paraformer ASR plus Mclaw-hosted text analysis."""
    ...
    # ------------------------------------------------------------------
    # Mclaw Plugin LLM analysis methods
    # ------------------------------------------------------------------
    ...
    async def _qwen_analyze_with_retry(
        ...
        *,
        ...
        """Analyze through the Mclaw Plugin LLM facade only."""
    ...
    async def _host_analyze_with_retry(
        ...
        *,
        ...
        if api is None:
            raise AsrError(
                "Mclaw Plugin LLM is unavailable. Grant brain.access and configure a text model.",
                kind="auth",
            )
