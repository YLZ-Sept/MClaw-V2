...
# refuses to import ``mclaw.plugins.api`` (StrEnum). We stub the
...
def _load_plugin_module() -> types.ModuleType:
    ...
    # Stub mclaw.plugins.api so ``from mclaw.plugins.api import
    # PluginAPI, PluginBase`` succeeds.
    mclaw_pkg = types.ModuleType("mclaw")
    plugins_pkg = types.ModuleType("mclaw.plugins")
    api_mod = types.ModuleType("mclaw.plugins.api")
    ...
    mclaw_pkg.plugins = plugins_pkg

    sys.modules.setdefault("mclaw", mclaw_pkg)
    sys.modules.setdefault("mclaw.plugins", plugins_pkg)
    sys.modules.setdefault("mclaw.plugins.api", api_mod)
