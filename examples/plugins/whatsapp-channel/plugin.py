"""whatsapp-channel: WhatsApp IM adapter plugin for Mclaw.
...
class WhatsAppAdapter(ChannelAdapter):
    ...
    def __init__(
        ...
        *,
        ...
        self._verify_token = creds.get("verify_token", "mclaw-verify")
    ...
    async def _start_baileys_bridge(self) -> None:
        ...
        data_dir = self._bridge_data_dir or str(Path(tempfile.gettempdir()) / "mclaw-wa-bridge")
