...
All mclaw.llm imports are deferred to on_load() to avoid circular imports
...
class Plugin(PluginBase):
    def on_load(self, api: PluginAPI) -> None:
        ...
        from mclaw.llm.registries.base import ModelInfo, ProviderInfo, ProviderRegistry
        from mclaw.llm.types import LLMRequest, LLMResponse, StopReason, TextBlock, Usage
