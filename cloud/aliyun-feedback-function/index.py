...
def _create_github_issue(
    ...
    body_parts += [
        ...
        "",
        "---",
        "*Auto-created by Mclaw Feedback Service*",
    ]
...
def _send_notification(
    ...
    try:
        requests.post(
            ...
            json={
                "from": "Mclaw Feedback <onboarding@resend.dev>",
                "to": [email],
    ...
    try:
        requests.post(
            ...
            json={
                "from": "Mclaw Feedback <onboarding@resend.dev>",
                "to": [user_email],
                "subject": f"[Mclaw] 您的反馈有新回复: {title}",
                "html": (
                    ...
                    f"您可以在 Mclaw 设置中心的「我的反馈」页面查看完整进度。<br/>"
                    f"You can view the full progress in the 'My Feedback' page of Mclaw Setup Center.</p>"
                    f"{unsub_html}"
                ),
            },
            timeout=10,
