...
"@
    ...
    Write-Info "提示: 通过 Setup Center 或 mclaw llm-config 添加 LLM 端点"
...
function Show-Completion {
    ...
    Write-Host "     mclaw llm-config" -ForegroundColor Cyan -NoNewline
    ...
    Write-Host "     mclaw" -ForegroundColor Cyan -NoNewline
    Write-Host "        # 交互模式" -ForegroundColor Gray
    Write-Host "     mclaw serve" -ForegroundColor Cyan -NoNewline
