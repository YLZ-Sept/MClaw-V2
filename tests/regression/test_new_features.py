...
class TestSession:
    ...
    def test_session_creation(self):
        """测试会话创建"""
        from mclaw.sessions import Session, SessionConfig
    ...
    def test_session_context(self):
        """测试会话上下文"""
        from mclaw.sessions import Session, SessionContext
    ...
    def test_session_expiry(self):
        """测试会话冷归档过期"""
        from mclaw.sessions import Session
...
class TestSessionManager:
    ...
    def test_get_or_create_session(self, temp_storage):
        """测试获取或创建会话"""
        from mclaw.sessions import SessionManager
...
class TestUserManager:
    ...
    def test_user_creation(self, temp_storage):
        """测试用户创建"""
        from mclaw.sessions import UserManager
...
class TestTriggers:
    ...
    def test_once_trigger(self):
        """测试一次性触发器"""
        from mclaw.scheduler import OnceTrigger
    ...
    def test_interval_trigger(self):
        """测试间隔触发器"""
        from mclaw.scheduler import IntervalTrigger
    ...
    def test_cron_trigger(self):
        """测试 Cron 触发器"""
        from mclaw.scheduler import CronTrigger
...
class TestScheduledTask:
    ...
    def test_task_creation(self):
        """测试任务创建"""
        from mclaw.scheduler import ScheduledTask, TriggerType
    ...
    def test_task_lifecycle(self):
        """测试任务生命周期"""
        from mclaw.scheduler import ScheduledTask, TaskStatus
...
class TestTaskScheduler:
    ...
    async def test_scheduler_basic(self, temp_storage):
        """测试调度器基本功能"""
        from mclaw.scheduler import TaskScheduler, ScheduledTask
...
class TestMessageTypes:
    ...
    def test_media_file(self):
        """测试媒体文件"""
        from mclaw.channels import MediaFile
    ...
    def test_message_content(self):
        """测试消息内容"""
        from mclaw.channels import MessageContent, MediaFile, MessageType
    ...
    def test_unified_message(self):
        """测试统一消息"""
        from mclaw.channels import UnifiedMessage, MessageContent
    ...
    def test_message_plain_text(self):
        """测试消息转纯文本"""
        from mclaw.channels import MessageContent, MediaFile
...
class TestTelegramAdapter:
    ...
    async def test_telegram_adapter_init(self):
        ...
        try:
            from mclaw.channels.adapters import TelegramAdapter
...
class TestTelegramIntegration:
    ...
    async def test_telegram_full_flow(self):
        ...
        try:
            from mclaw.channels.adapters import TelegramAdapter
            from mclaw.channels import UnifiedMessage
...
class TestMediaHandler:
    ...
    def test_media_handler_init(self):
        """测试媒体处理器初始化"""
        from mclaw.channels.media import MediaHandler
...
class TestMediaStorage:
    ...
    async def test_storage_basic(self, temp_storage):
        """测试基本存储功能"""
        from mclaw.channels.media import MediaStorage
        from mclaw.channels import MediaFile
...
class TestIntegration:
    ...
    async def test_full_message_flow(self, tmp_path):
        """完整消息流程测试"""
        from mclaw.sessions import SessionManager
        from mclaw.channels import MessageGateway, MessageContent, UnifiedMessage
        from mclaw.channels.base import CLIAdapter
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Mclaw 新功能测试")
    parser.add_argument(
