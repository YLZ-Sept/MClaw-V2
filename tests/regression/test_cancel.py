...
class TestTaskStateCancelEvent:
    ...
    def test_cancel_event_exists(self):
        ...
        from mclaw.core.agent_state import TaskState
    ...
    def test_cancel_sets_event(self):
        ...
        from mclaw.core.agent_state import TaskState, TaskStatus
...
class TestReasonWithHeartbeatCancel:
    ...
    async def test_cancel_during_reason(self):
        ...
        from mclaw.agent.errors import UserCancelledError
        from mclaw.core.agent_state import AgentState, TaskStatus
