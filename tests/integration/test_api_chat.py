...
def app(mock_agent, monkeypatch):
    from mclaw.api.routes import chat as chat_routes
    from mclaw.api.routes import conversation_lifecycle
...
class TestChatSyncEndpoint:
    ...
    async def test_sync_returns_409_when_conversation_busy(self, client, mock_agent, monkeypatch):
        ...
        from mclaw.api.routes import chat as chat_routes
        from mclaw.api.routes.conversation_lifecycle import get_lifecycle_manager
