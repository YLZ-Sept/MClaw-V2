...
from mclaw.channels.base import ChannelAdapter
from mclaw.channels.types import MessageContent, OutgoingMessage
...
class TestTelegramAdapterInit:
    ...
    def test_import_succeeds(self):
        from mclaw.channels.adapters.telegram import TelegramAdapter
...
class TestFeishuAdapterInit:
    def test_import_succeeds(self):
        from mclaw.channels.adapters.feishu import FeishuAdapter
...
class TestDingTalkAdapterInit:
    def test_import_succeeds(self):
        from mclaw.channels.adapters.dingtalk import DingTalkAdapter
...
class TestOneBotAdapterInit:
    def test_import_succeeds(self):
        from mclaw.channels.adapters.onebot import OneBotAdapter
...
class TestWeWorkAdapterInit:
    def test_import_succeeds(self):
        from mclaw.channels.adapters.wework_bot import WeWorkBotAdapter
...
class TestQQBotAdapterInit:
    def test_import_succeeds(self):
        from mclaw.channels.adapters.qq_official import QQBotAdapter
