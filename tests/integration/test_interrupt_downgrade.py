...
from mclaw.core.tool_interrupt_behavior import (
    DEFAULT_BEHAVIOR,
...
class TestMcpSubToolEncoding:
    ...
    def test_encode_missing_pieces_falls_back(self) -> None:
        from mclaw.core.tool_interrupt_behavior import encode_mcp_sub_tool
    ...
    def test_parse_rejects_non_mcp_names(self) -> None:
        from mclaw.core.tool_interrupt_behavior import parse_mcp_sub_tool
