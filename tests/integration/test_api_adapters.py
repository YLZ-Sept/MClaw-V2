...
# 导入所有适配器
from src.mclaw.integrations.adapters.mail import create_mail_adapter
from src.mclaw.integrations.adapters.sheets import create_sheets_adapter
from src.mclaw.integrations.adapters.crm import create_crm_adapter
from src.mclaw.integrations.adapters.im import create_im_adapter
from src.mclaw.integrations.adapters.storage import create_storage_adapter
from src.mclaw.integrations.adapters.sms import create_sms_adapter
from src.mclaw.integrations.adapters.payment import create_payment_adapter
from src.mclaw.integrations.adapters.map import create_map_adapter
from src.mclaw.integrations.adapters.weather import create_weather_adapter
from src.mclaw.integrations.adapters.news import create_news_adapter
