...
from mclaw.core.intent_analyzer import (
    IntentAnalyzer,
    IntentResult,
    IntentType,
...
from mclaw.prompt.compiler import check_compiled_outdated, compile_all
from mclaw.tools.catalog import ToolCatalog
...
class TestPromptCompilerOwnership:
    ...
    def test_no_compile_agent_tooling_function(self):
        from mclaw.prompt import compiler
...
class TestContextManagerOptimizations:
    def test_token_cache_consistency(self):
        from mclaw.agent.context import ContextManager
...
class TestIdentityRouteNoTooling:
    def test_budget_map_no_tooling(self):
        from mclaw.api.routes.identity import _BUDGET_MAP
    ...
    def test_editable_files_exclude_compiled_runtime_artifacts(self):
        from mclaw.api.routes.identity import _EDITABLE_SOURCE_FILES
    ...
    async def test_compiled_runtime_artifacts_are_not_writable(self):
        ...
        from mclaw.api.routes.identity import FileWriteRequest, write_identity_file
