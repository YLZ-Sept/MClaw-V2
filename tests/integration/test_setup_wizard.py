...
from mclaw.setup.wizard import SetupWizard
...
class TestGenerateEnvContent:
    ...
    def test_env_contains_agent_settings(self, wizard):
        ...
        # silently revert to "Mclaw" on first launch.
...
class TestCreateIdentityExamples:
    def test_creates_soul_md_from_template(self, wizard, tmp_path):
        ...
        hardcoded ``你是 Mclaw`` and that stub then masked the templated
        ...
        assert "你是 Mclaw，一个忠诚可靠的 AI 助手。" not in content
