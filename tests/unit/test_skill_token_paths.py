...
from mclaw.core.prompt_assembler import PromptAssembler
from mclaw.prompt.builder import PromptProfile, _build_catalogs_section
from mclaw.skills.catalog import (
    SKILL_INSTRUCTION_ADVISORY,
    SKILL_METADATA_ADVISORY,
    SkillCatalog,
)
from mclaw.skills.registry import SkillEntry
...
async def test_prompt_assembler_passes_intent_tool_hints(monkeypatch):
    ...
    monkeypatch.setattr("mclaw.prompt.builder.build_system_prompt", fake_build_system_prompt)
