...
Covers :func:`mclaw.plugins.reseed.apply_reseed` (the pure copier) and
the :class:`mclaw.cli.plugins_cmd.plugins_app` Typer sub-app.
...
# Workaround for pre-existing mclaw import cycle: pre-load ``mclaw.agent``
...
from mclaw.cli.plugins_cmd import plugins_app
