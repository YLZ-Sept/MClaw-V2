...
from mclaw.api.routes import plugins as plugin_routes
...
async def test_management_api_updates_canonical_config_with_atomic_writer(
    ...
    from mclaw.plugins import config_store
...
async def test_saved_plugin_config_is_not_reported_as_save_failure_when_runtime_apply_fails(
    ...
    monkeypatch.setattr(
        "mclaw.runtime_config_coordinator.get_runtime_config_coordinator",
...
def test_plugin_api_migrates_legacy_config_before_management_api_is_opened(
    ...
    from mclaw.plugins.api import PluginAPI
    from mclaw.plugins.config_store import PluginConfigStore
    from mclaw.plugins.manifest import BASIC_PERMISSIONS, PluginManifest
