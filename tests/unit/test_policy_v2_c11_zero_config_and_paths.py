...
新用户 ``pip install mclaw`` 后无 ``identity/POLICIES.yaml``、无环境
...
Mclaw 跑在 Win / macOS / Linux. PathSpec 与 ``_path_under`` 必须保证:
...
from mclaw.core.policy_v2.context import PolicyContext
from mclaw.core.policy_v2.engine import PolicyEngineV2
from mclaw.core.policy_v2.enums import ConfirmationMode, DecisionAction, SessionRole
from mclaw.core.policy_v2.models import ToolCallEvent
from mclaw.core.policy_v2.safety_immune_defaults import (
...
class TestR518ZeroConfigFirstInstall:
    ...
    def test_zero_config_global_engine_singleton_loads(self, monkeypatch, tmp_path):
        ...
        try:
            ...
            monkeypatch.setattr(
                "mclaw.core.policy_v2.global_engine.Path",
                Path,
            )
