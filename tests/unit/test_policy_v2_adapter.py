...
from mclaw.core.policy_v2.adapter import (
...
class TestV2ToV1DecisionStringMap:
    ...
    def test_allow(self):
        from mclaw.core.policy_v2.adapter import V2_TO_V1_DECISION
...
class TestFailClosed:
    def test_risky_tool_engine_crash_returns_deny(self, monkeypatch):
        ...
        monkeypatch.setattr("mclaw.core.policy_v2.adapter._get_engine", _boom)
