...
from mclaw.channels.adapters.wework_ws import (
    CMD_CALLBACK,
    CMD_EVENT_CALLBACK,
    CMD_HEARTBEAT,
    CMD_RESPONSE,
...
from mclaw.channels.types import MediaFile, OutgoingMessage
...
class TestDownloadMedia:
    ...
    async def test_download_plain_file(self, connected_adapter, tmp_path):
        ...
        from mclaw.channels.adapters.wework_ws import _import_httpx
        ...
        with patch("mclaw.channels.adapters.wework_ws.httpx") as mock_httpx:
