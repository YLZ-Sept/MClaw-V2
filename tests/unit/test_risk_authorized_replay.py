...
from mclaw.agent.safety.destructive_intent import consume_risk_authorization as _consume_risk_authorization
...
async def test_pending_risk_confirm_with_no_action_returns_authorized_replay():
    ...
    from mclaw.api.routes import chat as chat_mod
...
def test_format_controlled_action_result_neutral_on_error():
    ...
    from mclaw.api.routes import chat as chat_mod
    from mclaw.core.confirmation_state import ConfirmationDecision
