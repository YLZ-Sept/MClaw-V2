...
from mclaw.api.routes import inbox as inbox_routes
from mclaw.inbox.models import InboxMessage
from mclaw.inbox.service import InboxService
from mclaw.inbox.store import InboxStore


async def test_inbox_routes_list_detail_and_mark(monkeypatch, tmp_path) -> None:
    monkeypatch.setattr("mclaw.config.settings.inbox_register_enabled", False)
