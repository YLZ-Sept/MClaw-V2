...
from mclaw.tools.handlers.web_fetch import WebFetchHandler
...
def _safe_url(monkeypatch):
    ...
    monkeypatch.setattr("mclaw.utils.url_safety.is_safe_url", _always_safe)
...
async def test_web_fetch_reserved_benchmark_dns_hint_does_not_fetch(monkeypatch, _fake_httpx):
    ...
    monkeypatch.setattr("mclaw.utils.url_safety.is_safe_url", _unsafe_19818)
