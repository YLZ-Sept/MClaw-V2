...
from mclaw.tools.web_search import runtime as web_search_runtime
from mclaw.tools.web_search.base import (
...
async def test_web_search_attempt_timeout_is_soft_guidance(monkeypatch):
    ...
    monkeypatch.setattr("mclaw.tools.handlers.web_search.run_web_search", fake_run_web_search)
...
async def test_web_search_no_provider_available_raises_config_hint(monkeypatch):
    ...
    from mclaw.tools.web_search.base import NoProviderAvailable
