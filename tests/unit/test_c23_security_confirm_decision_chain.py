...
from mclaw.core.policy_v2.display import security_confirm_display
from mclaw.core.policy_v2.enums import ApprovalClass, DecisionAction, DecisionSource
from mclaw.core.policy_v2.models import DecisionStep, PolicyDecisionV2
...
class TestSecurityConfirmDisplay:
    def test_confirmation_display_uses_tool_policy_metadata(self) -> None:
        display = security_confirm_display(
            ...
            args={"query": "MCLAW_RISKGATE_689_REPRO_TEST"},
...
class TestPayloadIntegration:
    ...
    def test_yield_points_include_decision_chain(self) -> None:
        ...
        engine_src = Path("src/mclaw/core/_reasoning_runtime.py").read_text(encoding="utf-8")
        channel_src = Path("src/mclaw/core/security_confirm_channel.py").read_text(
            encoding="utf-8"
        )
        risk_gate_tools_src = Path("src/mclaw/core/risk_gate_tools.py").read_text(
            encoding="utf-8"
        )
    ...
    def test_to_ui_chain_used_at_module_level(self) -> None:
        ...
        models_src = Path("src/mclaw/core/policy_v2/models.py").read_text(encoding="utf-8")
