...
from mclaw.core.policy_v2 import audit_chain as ac
from mclaw.core.policy_v2.param_mutation_audit import _sanitize_for_chain
...
class TestReadyzAuditPathFix:
    ...
    def test_probe_uses_audit_logger_path(
        ...
        from mclaw.agent import audit as al
...
class TestHugeLineTailReload:
    ...
    def test_helper_returns_none_for_oversize_single_line(self, tmp_path: Path) -> None:
        ...
        import mclaw.core.policy_v2.audit_chain as ac_mod
...
class TestEvolutionAuditFallback:
    ...
    def test_oserror_falls_through_to_raw_append(
        ...
        from mclaw.core.policy_v2 import evolution_window as ew
        ...
        monkeypatch.setattr(
            "mclaw.core.policy_v2.audit_chain.get_writer",
