...
from mclaw.tools.file import DEFAULT_IGNORE_DIRS, FileTool
...
def handler(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "mclaw.core.policy_v2.get_config_v2",
        lambda: _Config(),
    )
    agent = MagicMock()
...
class TestToolDefinitions:
    ...
    def test_filesystem_tools_count(self):
        from mclaw.tools.definitions.filesystem import FILESYSTEM_TOOLS
    ...
    def test_all_in_base_tools(self):
        from mclaw.tools.definitions import BASE_TOOLS
    ...
    def test_high_freq_tools(self):
        from mclaw.tools.catalog import HIGH_FREQ_TOOLS
    ...
    def test_small_ctx_core_tools(self):
        from mclaw.core._agent_runtime import SMALL_CTX_CORE_TOOLS

        assert "edit_file" in SMALL_CTX_CORE_TOOLS
        assert "grep" in SMALL_CTX_CORE_TOOLS

    def test_medium_ctx_extra_tools(self):
        from mclaw.core._agent_runtime import MEDIUM_CTX_EXTRA_TOOLS
