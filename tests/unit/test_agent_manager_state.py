...
from mclaw.api import agent_events
from mclaw.api.routes.agents import _build_agent_manager_state
...
def test_agent_change_events_use_stable_websocket_names(monkeypatch):
    ...
    monkeypatch.setattr("mclaw.api.routes.websocket.fire_event", fake_fire_event)
