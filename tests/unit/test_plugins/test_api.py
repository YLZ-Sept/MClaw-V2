"""Tests for mclaw.plugins.api — PluginAPI and permission enforcement."""
...
from mclaw.plugins.hooks import HookRegistry
from mclaw.plugins.manifest import BASIC_PERMISSIONS, PluginManifest
from mclaw.plugins.sandbox import PluginErrorTracker
...
class TestRegisterLlmProvider:
    def test_requires_llm_register_permission(self, tmp_path):
        ...
        from mclaw.plugins import PLUGIN_PROVIDER_MAP
...
class TestBroadcastUiEvent:
    ...
    async def test_uses_websocket_broadcast_not_im_gateway(self, tmp_path):
        ...
        with patch(
            "mclaw.api.routes.websocket.broadcast_event",
