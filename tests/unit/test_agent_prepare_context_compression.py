...
from mclaw.core._context_runtime import _CancelledError as _CtxCancelledError
from mclaw.core.agent_state import AgentState
from mclaw.core.im_context import get_im_gateway, get_im_session, reset_im_context
...
async def test_trait_mining_background_does_not_block_and_persists(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "mclaw.agent.persona.persist_trait_to_memory",
