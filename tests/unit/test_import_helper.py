...
from mclaw.tools._import_helper import _PACKAGE_MODULE_MAP, _build_hint, import_or_hint
...
def test_frozen_optional_module_hint_mentions_setup_center():
    with patch("mclaw.tools._import_helper.IS_FROZEN", True):
...
def test_development_hint_names_the_pip_package():
    with patch("mclaw.tools._import_helper.IS_FROZEN", False):
        hint = _build_hint("sentence_transformers")
