...
def patched_env(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("mclaw.skills.watcher.clear_all_skill_caches", clear_caches_mock)
    monkeypatch.setattr("mclaw.skills.allowlist_io.read_allowlist", read_allowlist_mock)
    monkeypatch.setattr(
        "mclaw.skills.preset_utils.collect_preset_referenced_skills",
        collect_skills_mock,
    )
    monkeypatch.setattr(
        "mclaw.core._agent_runtime.Agent.notify_pools_skills_changed",
        staticmethod(notify_pools_mock),
    )
    monkeypatch.setattr("mclaw.skills.events.notify_skills_changed", notify_changed_mock)
