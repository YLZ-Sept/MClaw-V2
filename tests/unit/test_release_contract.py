...
def test_release_contract_accepts_new_release_for_matching_lightweight_tag() -> None:
    ...
    fetcher = _Fetcher(
        {
            "repos/mclaw/mclaw/git/ref/tags/v1.2.3": {
                "object": {"type": "commit", "sha": commit}
            },
            "repos/mclaw/mclaw/releases/tags/v1.2.3": None,
        }
    )
    ...
    fetcher = _Fetcher(
        {
            ...
            f"repos/mclaw/mclaw/git/tags/{tag_object}": {
                "object": {"type": "commit", "sha": commit}
            },
            "repos/mclaw/mclaw/releases/tags/v1.2.3": {"assets": []},
        }
    )
    ...
    fetcher = _Fetcher(
        {
            ...
            "repos/mclaw/mclaw/releases/123": {
                "id": 123,
                "tag_name": "v1.2.3",
                "draft": True,
                "assets": [],
    ...
    fetcher = _Fetcher(
        {
            ...
            "repos/mclaw/mclaw/releases/tags/v1.2.3": {
                "assets": [{"name": "Mclaw-v1.2.3.dmg"}]
            },
        }
    )
...
def test_release_contract_can_scope_collision_check_to_mobile_assets() -> None:
    ...
    fetcher = _Fetcher(
        {
            ...
            "repos/mclaw/mclaw/releases/tags/v1.2.3": {
                "assets": [{"name": .mclaw-1.2.3-py3-none-any.whl"}]
            },
        }
    )
    ...
    check_release_contract(
        ...
        tag="v1.2.3",
        expected_commit=commit,
        asset_names=["Mclaw-v1.2.3-android.apk"],
        require_release=True,
        fetch_json=fetcher,
    )
