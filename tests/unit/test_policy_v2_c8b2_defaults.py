...
from mclaw.core.policy_v2.shell_risk import (
...
class TestSubsystemsReadV2Config:
    ...
    def _install_v2_config(cfg) -> None:
        ...
        from mclaw.core.policy_v2.engine import build_engine_from_config
        from mclaw.core.policy_v2.global_engine import set_engine_v2
    ...
    def test_audit_logger_reads_v2_audit_config(self, tmp_path) -> None:
        ...
        from mclaw.agent.audit import reset_audit_logger
        from mclaw.core.policy_v2.global_engine import reset_engine_v2
        from mclaw.core.policy_v2.schema import AuditConfig, PolicyConfigV2
    ...
    def test_checkpoint_manager_reads_v2_checkpoint_config(self, tmp_path) -> None:
        from mclaw.core.policy_v2.global_engine import reset_engine_v2
        from mclaw.core.policy_v2.schema import CheckpointConfig, PolicyConfigV2
        ...
        import mclaw.core.checkpoint as ck_mod
...
class TestResetPolicyV2Layer:
    ...
    def test_reset_clears_audit_logger_singleton(self) -> None:
        from mclaw.agent.audit import get_audit_logger
        from mclaw.core.policy_v2.global_engine import reset_policy_v2_layer
