...
from mclaw.agent.ui_confirm_bus import UIConfirmBus, reset_ui_confirm_bus
from mclaw.api.routes import config as config_routes
from mclaw.core.policy_v2 import global_engine
from mclaw.core.policy_v2.engine import build_engine_from_config
from mclaw.core.policy_v2.schema import ConfirmationConfig, PolicyConfigV2
...
class TestBatchEndpoint:
    ...
    def test_endpoint_resolves_riskgate_tool_call_through_unified_resolver(
        ...
        classification = {
            ...
            "riskgate_scope": {"query": "MCLAW_RISKGATE_689_REPRO_TEST"},
        }
        pending = (
