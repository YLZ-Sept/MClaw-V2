"""Unit tests for `_apply_agent_profile` in `mclaw.api.routes.chat`.
...
from mclaw.api.routes.chat import _apply_agent_profile
...
class TestApplyAgentProfileCustomStore:
    def test_custom_profile_in_store_is_accepted(self, monkeypatch):
        ...
        from mclaw.agents import profile as profile_mod
