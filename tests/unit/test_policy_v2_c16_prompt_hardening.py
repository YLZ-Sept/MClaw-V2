...
from mclaw.core.policy_v2.prompt_hardening import (
...
def test_safety_section_contains_hardening_rules():
    ...
    from mclaw.prompt import builder
...
def test_tool_summary_replay_path_wraps_content():
    ...
    glue.
    """
    from mclaw.core import _agent_runtime as _agent_mod
    from mclaw.core.policy_v2 import prompt_hardening
