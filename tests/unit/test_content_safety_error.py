...
from mclaw.llm.providers.openai import _humanize_upstream_error
from mclaw.utils.errors import ErrorCategory, classify_error
...
class TestFriendlyErrorHint:
    ...
    def test_invalid_function_response_hint_is_specific(self):
        ...
        # Mclaw 会清理工具历史后重试”。本测试只保证：1) 提示是工具相关而不是
