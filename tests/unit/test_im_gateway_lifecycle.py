...
async def test_empty_gateway_starts_without_dependency_check_and_accepts_hot_bot(monkeypatch):
    import mclaw.channels as channels
    import mclaw.logging as mclaw_logging

    monkeypatch.setattr(mclaw_logging, "setup_logging", lambda **_kwargs: None)
    import mclaw.main as main
