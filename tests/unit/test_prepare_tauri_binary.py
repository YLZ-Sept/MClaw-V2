...
def test_prepare_binary_accepts_restored_destination(tmp_path: Path, monkeypatch) -> None:
    ...
    suffix = ".exe" if module.sys.platform == "win32" else ""
    expected = release_dir / f"mclaw-desktop{suffix}"
