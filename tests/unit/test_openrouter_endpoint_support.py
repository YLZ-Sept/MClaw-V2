...
from mclaw.llm.registries.openrouter import OpenRouterRegistry
from mclaw.setup_center.bridge import _list_models_openai
...
async def test_openrouter_registry_falls_back_to_router_models(monkeypatch):
    ...
    monkeypatch.setattr(
        "mclaw.llm.registries.openrouter.create_registry_client",
