...
class TestHardening:
    ...
    def test_v2_blocks_derived_from_schema_fields(self) -> None:
        ...
        """
        from mclaw.core.policy_v2 import PolicyConfigV2
        from mclaw.core.policy_v2.migration import _V2_BLOCKS
    ...
    def test_legacy_mode_aliases_single_source_of_truth(self) -> None:
        ...
        from mclaw.core.policy_v2 import context as ctx
        from mclaw.core.policy_v2.enums import LEGACY_MODE_ALIASES
        from mclaw.core.policy_v2.migration import LEGACY_MODE_ALIASES as M_ALIAS
