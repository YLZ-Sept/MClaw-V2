...
from mclaw.optional_assets import OptionalAssetMirror
from mclaw.tools.browser import manager
...
def test_managed_browsers_dir_respects_mclaw_root(tmp_path: Path, monkeypatch) -> None:
    monkeypatch.delenv("PLAYWRIGHT_BROWSERS_PATH", raising=False)
    monkeypatch.setenv("MCLAW_ROOT", str(tmp_path))
...
async def test_download_managed_chromium_uses_bundled_driver_cli(
    ...
    monkeypatch.setattr(
        "mclaw.optional_features.configure_playwright_driver",
