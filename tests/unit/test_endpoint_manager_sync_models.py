...
from mclaw.llm.model_probe import ProbeAuthError
...
def test_sync_writes_supported_models_and_clears_error(monkeypatch, manager_with_relay):
    ...
    monkeypatch.setattr("mclaw.llm.endpoint_manager.probe_models", fake_probe, raising=False)
    ...
    monkeypatch.setattr("mclaw.llm.model_probe.probe_models", fake_probe)
...
def test_sync_failure_preserves_previous_catalog(monkeypatch, manager_with_relay):
    ...
    monkeypatch.setattr(
        "mclaw.llm.model_probe.probe_models",
    ...
    monkeypatch.setattr("mclaw.llm.model_probe.probe_models", fake_probe_fail)
    result = manager_with_relay.sync_endpoint_models("yunwu-relay")
