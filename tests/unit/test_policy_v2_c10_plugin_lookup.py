...
from mclaw.core.policy_v2.enums import ApprovalClass, DecisionSource
from mclaw.plugins.manager import PluginManager
from mclaw.plugins.manifest import PluginManifest
...
def _write_plugin(tmp: Path, plugin_id: str, manifest: dict) -> Path:
    ...
    (plugin_dir / "plugin.py").write_text(
        "from mclaw_plugin_sdk import PluginBase\nclass Plugin(PluginBase):\n    pass\n",
        encoding="utf-8",
    )
    return plugin_dir
...
class TestPluginManagerGetToolClass:
    ...
    def test_unknown_class_value_skipped(self, tmp_plugins_dir, caplog):
        ...
        with caplog.at_level("WARNING", logger="mclaw.plugins.manager"):
