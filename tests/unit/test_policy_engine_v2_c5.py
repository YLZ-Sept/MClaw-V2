...
class TestSessionCoercion:
    def test_replay_dict_form_coerced(self) -> None:
        from mclaw.core.policy_v2.context import _coerce_replay_auths
    ...
    def test_trust_v1_overrides_dict_with_rules_coerced(self) -> None:
        from mclaw.core.policy_v2.context import _coerce_trusted_paths
...
class TestC5AuditFixes:
    ...
    def test_audit_d_classifier_config_split_brain_warning(self, caplog) -> None:
        ...
        from mclaw.core.policy_v2 import ApprovalClassifier, ShellRiskConfig
        ...
        with caplog.at_level(logging.WARNING, logger="mclaw.core.policy_v2.engine"):
