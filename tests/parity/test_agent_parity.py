...
1.  :func:`inspect.getfile` of the v1 and v2 ``Agent`` classes
    ...
    ``mclaw.agent.core`` module and the renamed
    ``mclaw.core._agent_runtime`` module respectively).
...
from mclaw.core._agent_runtime import Agent as V1Agent
...
def test_v2_inherits_from_legacy() -> None:
    ...
    assert V2Agent.__module__ == "mclaw.agent.core"
...
def test_v2_specific_routing_label_set() -> None:
    ...
    """
    from mclaw.agent.core import _RISK_LABEL_TO_NODE
