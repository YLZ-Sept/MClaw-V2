...
This package proves that the v2 ``src/mclaw/runtime/orgs/``
subsystems behave identically to the v1 ``src/mclaw/orgs/``
...
def _blackboard_v1(case: ParityCase) -> ParityResult:
    from mclaw.orgs.blackboard import OrgBlackboard
    # ... call v1 path ...
    return ParityResult(...)
