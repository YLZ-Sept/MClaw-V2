...
v1 ``src/mclaw/orgs/runtime.py`` is a 6 355 LOC monolith
...
from mclaw.orgs._runtime_node_lifecycle import (
    STATUS_BUSY,
    STATUS_IDLE,
    NodeMessageRouter,
...
from mclaw.orgs._runtime_plugin_assets import (
    FileOutputRegistry,
    PluginAssetRecorder,
...
# v2 does not import mclaw.orgs at all).
# ---------------------------------------------------------------------------
