...
`mclaw.orgs.blackboard.OrgBlackboard` and asserts
...
def _bb_v2(case: ParityCase, org_dir: Path) -> ParityResult:
    ...
    from mclaw.orgs.blackboard import OrgBlackboard as V2Blackboard
    from mclaw.orgs.memory_models import MemoryScope, MemoryType
