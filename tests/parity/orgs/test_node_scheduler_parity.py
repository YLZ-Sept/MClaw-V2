...
the v2 ``mclaw.orgs.node_scheduler.OrgNodeScheduler``
...
def _next_fire_v2(case: ParityCase, now: datetime) -> ParityResult:
    ...
    from mclaw.orgs.node_scheduler import compute_next_fire_time
    from mclaw.orgs.scheduler_models import NodeSchedule as V2NS
    from mclaw.orgs.scheduler_models import ScheduleType as V2ST
...
def _v2_capture_prompt(case: ParityCase) -> str:
    ...
    from mclaw.orgs.node_scheduler import OrgNodeScheduler as V2Sched
    from mclaw.orgs.scheduler_models import NodeSchedule as V2NS
    from mclaw.orgs.scheduler_models import ScheduleType as V2ST
