...
1. ``inspect.getfile(...)`` of the v1 and v2 ``ReasoningEngine``
   ...
   ``mclaw.agent.reasoning`` module and the renamed
   ``mclaw.core._reasoning_runtime`` module
   respectively).
...
from mclaw.agent.reasoning import ReasoningEngine as V2Engine
from mclaw.agent.reasoning import build_reasoning_graph
