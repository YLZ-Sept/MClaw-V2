...
from mclaw.agent import Agent, ReasoningEngine, ToolExecutor
from mclaw.agent.pending_approvals import (
    get_pending_approvals_store,
    reset_pending_approvals_store,
)
from mclaw.api.routes.pending_approvals import _resume_task
from mclaw.config import settings
from mclaw.core.agent_state import AgentState
...
from mclaw.core.policy_v2.exceptions import DeferredApprovalRequired
from mclaw.orgs.manager import OrgManager
from mclaw.orgs.store import get_default_org_manager, set_default_org_manager
from mclaw.scheduler.task import ScheduledTask, TaskStatus, TriggerType
from mclaw.tools.definitions.org_setup import ORG_SETUP_TOOLS
from mclaw.tools.handlers import SystemHandlerRegistry
from mclaw.tools.handlers.org_setup import OrgSetupHandler
...
def _make_agent(registry: SystemHandlerRegistry, responses: list[MockResponse]) -> Agent:
    ...
    agent._resolve_agent_voice = lambda: "Mclaw"
