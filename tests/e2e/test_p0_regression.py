...
def test_p0_1_user_dirs_default_to_mutating_scoped_class():
    ...
    from mclaw.core.policy_v2.adapter import evaluate_via_v2
    from mclaw.core.policy_v2.enums import ConfirmationMode, DecisionAction
    from mclaw.core.policy_v2.global_engine import (
        reset_engine_v2,
        set_engine_v2,
    )
    from mclaw.core.policy_v2.schema import ConfirmationConfig
...
def test_p0_1_default_controlled_paths_include_user_dirs():
    ...
    """
    from mclaw.core.policy_v2 import default_controlled_paths
...
def test_p0_2_phase0_no_hard_exit_reason():
    ...
    src = Path("src/mclaw/core/_reasoning_runtime.py").read_text(encoding="utf-8")
    # 移除注释行后再检查赋值
...
def test_p0_2_phase0_action_done_regex_matches_chinese():
    ...
    from mclaw.core._reasoning_runtime import _get_action_done_re
...
def test_p0_2_phase2_intent_result_has_evidence_recommended_field():
    ...
    from mclaw.core.intent_analyzer import IntentResult, IntentType
...
def test_p0_2_phase3_source_tag_inconsistency_warns():
    ...
    from mclaw.core._reasoning_runtime import _check_source_tag_consistency
...
def test_p0_3_command_store_atomic_update():
    ...
    from mclaw.orgs.command_service import OrgCommandService
...
def test_p1_4_clean_user_content_filters_placeholders(raw: str, must_be_filtered_out: str):
    ...
    from mclaw.prompt.builder import _clean_user_content
...
async def test_p1_7_org_list_delegated_tasks_backoff(tmp_path: Path, monkeypatch):
    ...
    try:
        from mclaw.orgs._runtime_agent_pipeline import (  # type: ignore[attr-defined]
            OrgToolHandler,
        )
    except ImportError:
    ...
    monkeypatch.setattr(
        "mclaw.orgs.project_store.ProjectStore",
        _FakeStore,
        raising=False,
    )
