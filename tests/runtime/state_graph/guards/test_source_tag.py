...
``mclaw.core.reasoning_engine._check_source_tag_consistency`` to
...
def _legacy():
    ...
    import mclaw.agent.brain  # noqa: F401  (warm-up to break the cycle)
    from mclaw.core._reasoning_runtime import _check_source_tag_consistency as legacy
