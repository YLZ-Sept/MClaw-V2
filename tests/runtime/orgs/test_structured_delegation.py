...
from mclaw.orgs._default_agent_builder import _BrainBackedNodeAgent
from mclaw.orgs._runtime_agent_pipeline import AgentSpec, current_command_id_var
from mclaw.orgs._runtime_artifact_flow import artifact_ledger, record_tool_result
...
async def test_xml_dispatch_is_inert_by_default(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.delenv("MCLAW_ORG_LEGACY_TEXT_DISPATCH", raising=False)
