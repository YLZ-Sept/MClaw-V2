...
from mclaw.orgs._runtime_node_tools import run_with_tools
from mclaw.orgs.command_models import OrgCommandRequest
...
async def test_t_e_run_with_tools_forwards_cancel_event_both_rounds() -> None:
    ...
    import mclaw.tools.handlers as handlers_mod
...
async def test_t_f_legacy_agent_without_cancel_event_kwarg_still_runs() -> None:
    ...
    """
    from mclaw.orgs._runtime_agent_pipeline_executor import (
...
async def test_t_i_llm_client_race_with_cancel_aborts_provider_chat() -> None:
    ...
    """
    from mclaw.llm.client import LLMClient, UserCancelledError
