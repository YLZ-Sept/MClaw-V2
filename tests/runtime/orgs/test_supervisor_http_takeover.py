...
both build a :class:`~mclaw.runtime.supervisor.Supervisor` via
...
:class:`~mclaw.runtime.stall_detector.StallDetector` and is fed by
LLM-evaluated :class:`~mclaw.runtime.ledger.ProgressLedger`
signals.
