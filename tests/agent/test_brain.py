"""V2-only smoke test for :class:`mclaw.agent.brain.Brain`.
...
:class:`mclaw.agent.brain.Brain` against a stub LLMClient and
...
from mclaw.runtime.llm import EndpointFailoverView
...
class _StubLLMClient:
    """Mirror enough of :class:`mclaw.llm.client.LLMClient` to drive
