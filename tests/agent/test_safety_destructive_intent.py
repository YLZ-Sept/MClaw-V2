...
from mclaw.agent.safety import destructive_intent as di
from mclaw.core.risk_intent import RiskIntentResult, RiskLevel, TargetKind
...
def test_package_exports_are_stable() -> None:
    ...
    from mclaw.agent.safety import __all__ as pkg_all
    expected = {
        "DESTRUCTIVE_VERBS",
