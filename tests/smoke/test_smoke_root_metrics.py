...
def test_cache_control_injected_for_dashscope_qwen35():
    ...
    """
    from mclaw.llm.cache import SYSTEM_PROMPT_DYNAMIC_BOUNDARY
    from mclaw.llm.providers.openai import OpenAIProvider
    from mclaw.llm.types import EndpointConfig, LLMRequest, Message
...
def test_parse_response_extracts_cached_tokens():
    ...
    """
    from mclaw.llm.providers.openai import OpenAIProvider
    from mclaw.llm.types import EndpointConfig
...
def test_qwen35_plus_supports_cache():
    ...
    from mclaw.llm.model_registry import get_model_capabilities
...
def test_new_memory_immediately_recallable(tmp_path):
    ...
    新事实首轮召回率为 0。
    """
    from mclaw.memory.types import MemoryType, SemanticMemory
...
def test_profile_unknown_key_falls_back_to_memory():
    ...
    都视为回归。
    """
    from mclaw.core.feature_flags import clear_overrides, set_flag
    from mclaw.tools.handlers.profile import ProfileHandler
