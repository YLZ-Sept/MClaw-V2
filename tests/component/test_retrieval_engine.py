...
from mclaw.memory.retrieval import MemoryQueryPreprocessor, RetrievalEngine
from mclaw.memory.types import Episode, MemoryType, SemanticMemory
...
class TestRetrievalEngine:
    ...
    def test_retrieval_gate_keeps_short_reference_with_context(self):
        prepared = MemoryQueryPreprocessor.prepare(
            "这个文件",
            recent_messages=[{"role": "user", "content": "src/mclaw/memory/retrieval.py"}],
        )
        assert not prepared.skip
