...
### Phase 5: Register in Mclaw (CRITICAL)

**This step is mandatory.** After building and testing the MCP server, you MUST register it into the Mclaw system so the user can actually use it. Do NOT just show config snippets — call `add_mcp_server` to complete the registration.
