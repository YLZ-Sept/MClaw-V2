...
description: Download and install an Agent from the Mclaw Platform Agent Store
system: true
handler: agent_hub
...
Download and install an Agent from the Mclaw Platform Agent Store to the local system.
...
- Each installed skill gets a `.mclaw-origin.json` tracking its source and version
