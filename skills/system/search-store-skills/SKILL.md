...
description: Search for Skills on the Mclaw Platform Skill Store
system: true
handler: skill_store
...
Search for Skills on the Mclaw Platform Skill Store.

## When to Use

- User wants to find or browse Skills on the Mclaw marketplace
...
- **official**: Maintained by the Mclaw team
