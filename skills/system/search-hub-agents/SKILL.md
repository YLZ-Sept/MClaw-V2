...
description: Search for Agents on the Mclaw Platform Agent Store
system: true
handler: agent_hub
...
Search for Agents on the Mclaw Platform Agent Store.

## When to Use

- User wants to find or browse Agents on the Mclaw marketplace
