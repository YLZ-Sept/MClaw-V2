---
name: publish-agent
description: Publish a local Agent to the Mclaw Platform Agent Store. Package and prepare a local Agent for publishing to the community hub.
system: true
handler: agent_hub
...
Publish a local Agent to the Mclaw Platform Agent Store.
...
- Publish an Agent to the Mclaw hub
