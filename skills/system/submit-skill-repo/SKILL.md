...
description: Submit a GitHub repository to be indexed by the Mclaw Skill Store. Use when user wants to share their skills repo with the community.
system: true
handler: skill_store
...
Submit a GitHub repository to be indexed by the Mclaw Skill Store.
