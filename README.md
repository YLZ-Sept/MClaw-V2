<p align="center">
  <img src="docs/assets/logo.png" alt="Mclaw Logo" width="200" />
</p>
...
<p align="center">
  <a href="https://mclaw.ai"><img src="https://img.shields.io/badge/🌐_Website-mclaw.ai-orange?style=for-the-badge" alt="Official Website" height="28" /></a>
  &nbsp;
  <a href="https://mclaw.ai/download"><img src="https://img.shields.io/badge/📥_Download-Desktop_App-blue?style=for-the-badge" alt="Download" height="28" /></a>
  &nbsp;
...
<p align="center">
  ...
  <img src="https://img.shields.io/github/v/release/mclaw/mclaw?color=green&style=flat-square" alt="Version" height="20" />
  <img src="https://img.shields.io/pypi/v/mclaw?color=green&style=flat-square" alt="PyPI" height="20" />
  <img src="https://img.shields.io/github/actions/workflow/status/mclaw/mclaw/ci.yml?branch=main&style=flat-square" alt="Build Status" height="20" />
  <img src="https://img.shields.io/github/stars/mclaw/mclaw?style=flat-square" alt="Stars" height="20" />
</p>
...
1. **Download** the installer from [GitHub Releases](https://mclaw.ai/download)
...
```bash
# Install
pip install mclaw[all]

# Quick setup (interactive wizard)
mclaw init

# Run your first task
mclaw run "Build a weather scraper"
```
...
**Fully GUI-based, no command line** — this is what sets Mclaw apart from other open-source AI assistants:

<p align="center">
  <img src="docs/assets/en/desktop_quick_config.gif" alt="Mclaw Quick Setup" width="800" />
</p>
...
> **Download**: [GitHub Releases](https://mclaw.ai/download) — Windows (.exe) / macOS (.dmg) / Linux (.deb)
>
> Learn more at **[mclaw.ai](https://mclaw.ai)**

### Option 2: pip Install

```bash
pip install mclaw[all]    # Install with all optional features
mclaw init                # Run setup wizard
mclaw                     # Launch interactive CLI
```

### Option 3: Source Install

```bash
git clone https://github.com/mclaw/mclaw.git
cd mclaw
...
```bash
mclaw                              # Interactive chat
mclaw run "Build a calculator"     # Execute a single task
mclaw serve                        # Service mode (IM channels)
mclaw serve --dev                  # Dev mode with hot reload
mclaw daemon start                 # Background daemon
mclaw status                       # Check status
```
...
Mclaw supports **Desktop, Web, and Mobile** — use it anywhere, on any device:
...
<p align="center">
  <img src="docs/assets/desktop_terminal_en.png" alt="Mclaw Desktop App" width="800" />
</p>
...
<p align="center">
  ...
  <br/>
  <sub>▶ Click to watch: Built a company on Mclaw, and it runs autonomously (Bilibili)</sub>
</p>

Beyond multi-Agent collaboration — build an entire **AI company**. Mclaw includes a full organization orchestration engine (AgentOrg) that lets you visually design company structures in the GUI, where AI agents operate like a real company:
...
Mclaw has a built-in multi-Agent orchestration system — not just one AI, but an **AI team**:
...
<p align="center">
  ...
  <br/>
  <sub>▶ Click to watch: Mclaw scan-to-bind for WeChat, Feishu, WeCom (Bilibili)</sub>
</p>
...
Mclaw provides a complete plugin architecture with `plugin.json` manifest declarations, a 3-tier permission model for security, and 10 lifecycle hooks for deep integration:
...
Built on the `mclaw-plugin-sdk` (`contrib/` 6 modules: `verification`, `quality_gates`, `intent_verifier`, `provider_score`, `error_coach`, `slideshow_risk` / `source_review`). All ship with `SKILL.md` + `README.md` + tests.
...
> Developer docs: [Plugin System Overview](docs/plugin-system-overview.md) · [SDK contrib catalog](mclaw-plugin-sdk/docs/contrib.md) · [Sprint 18 Cleanup Assessment](docs/sprint18-cleanup-assessment.md)

---

## Sandbox Security

Mclaw implements a **6-layer defense-in-depth** security model, from path management to OS-level isolation:
...
Mclaw includes a full [MCP (Model Context Protocol)](https://modelcontextprotocol.io/) client, enabling AI to connect with any external service:
...
<table>
  <tr>
    ...
    <td align="center">
      ...
      <sub>Note "Mclaw" to join group</sub>
    </td>
    <td align="center">
...
<p align="center">
  🌐 <a href="https://mclaw.ai">Website</a> · 
  💬 <a href="https://discord.gg/vFwxNVNH">Discord</a> · 
  🐦 <a href="https://x.com/mclaw">X (Twitter)</a> · 
  📧 <a href="mailto:zacon365@gmail.com">Email</a>
</p>

<p align="center">
  <a href="https://github.com/mclaw/mclaw/issues">Issues</a> · 
  <a href="https://github.com/mclaw/mclaw/discussions">Discussions</a> · 
  <a href="https://github.com/mclaw/mclaw">⭐ Star</a>
</p>
...
Mclaw source code is licensed under the GNU Affero General Public License v3.0 only (AGPL-3.0-only) — See [LICENSE](LICENSE).

The `Mclaw` name, logos, icons, screenshots, and other brand assets are not licensed under AGPL-3.0-only. See [TRADEMARK.md](TRADEMARK.md) for brand usage rules.

Third-party licenses: [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md)

## Star History

<a href="https://star-history.com/#mclaw/mclaw&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=mclaw/mclaw&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=mclaw/mclaw&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=mclaw/mclaw&type=Date" />
 </picture>
</a>
...
<p align="center">
  <strong>Mclaw — Open-Source Multi-Agent AI Assistant That Gets Things Done</strong><br/>
  <a href="https://mclaw.ai">mclaw.ai</a>
</p>
