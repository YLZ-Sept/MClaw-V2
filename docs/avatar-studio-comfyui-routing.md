...
> 本文档是 avatar-studio 接入 ComfyKit / RunningHub 作为第二后端的实施路线决策。**只谈业务对接，不讲 ComfyUI 基础**——基础概念见 `D:/Mclaw_AI_Video/findings/comfyui_runninghub_intro.md`。
>
...
| 路径 | 用途 |
|---|---|
| `D:/Mclaw/plugins/avatar-studio/` | 插件代码 |
| `D:/Mclaw/plugins/avatar-studio/workflows/` | （新）workflow JSON |
| `D:/Mclaw/docs/avatar-studio-comfyui-routing.md` | 本文档 |
| `D:/Mclaw_AI_Video/findings/comfyui_runninghub_intro.md` | 基础扫盲 |
| `D:/Mclaw_AI_Video/findings/pixelle_video_deep.md` | Pixelle-Video 调研 |
| `D:/Mclaw_AI_Video/refs/Pixelle-Video/` | Pixelle-Video 源码参考 |
