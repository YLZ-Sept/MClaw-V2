...
```bash
rg "except ValueError" src/mclaw/ \
...
```bash
rg -n "# s5b-allow-force-write" src/mclaw/core/_reasoning_runtime.py
```
...
```bash
rg -n "except ValueError:" src/mclaw/core/_reasoning_runtime.py \
