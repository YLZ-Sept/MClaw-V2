...
1. P9.9 (final P-RC-9 phase) deletes ``src/mclaw/orgs/`` (v1
...
3. A **new v2.1.0 milestone task** owns the physical retirement:
   ``git rm src/mclaw/api/routes/_orgs_v2_deprecated_redirects.py``
   + drop its mount from ``src/mclaw/api/server.py``
