...
Mclaw's skill system enables dynamic capability extension.
...
```python
# skills/my_skill.py
from mclaw.skills.base import BaseSkill, SkillResult

class MySkill(BaseSkill):
    """A custom skill for Mclaw."""
...
mclaw skills run my_skill --input "test data"

# Install a skill from GitHub
mclaw skills install github:user/repo/skill_name
```
...
```python
from mclaw.skills import SkillRegistry
...
Mclaw can search GitHub for skills:
...
LOG_LEVEL=DEBUG mclaw

# Run skill in isolation
mclaw skills test my_skill
```
