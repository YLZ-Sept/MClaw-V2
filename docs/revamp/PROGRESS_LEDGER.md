...
> (`mclaw_full_backend_revamp_e6d8610d.plan.md`) and the
> continuation plan
> (`mclaw_revamp_continuation_plan_d6192647.plan.md`) before
...
`mclaw.agent.*` surface, fixes the one pre-existing circular
...
| `d16a47f8` | P-RC-7 P7.1 | refactor(sessions): retarget smart_truncate imports to mclaw.agent.tools | +2 / -2 (2 production callers) | 0 | ADR-0001, ADR-0003 |
| `716f622f` | P-RC-7 P7.2 | refactor(memory): retarget smart_truncate + Brain imports to mclaw.agent.* | +10 / -10 (5 files, 10 imports rewritten) | 0 | ADR-0001, ADR-0003 |
| `8af86b08` | P-RC-7 P7.3 | refactor(tools): retarget smart_truncate imports to mclaw.agent.tools | +2 / -2 (1 file, 2 imports) | 0 | ADR-0001, ADR-0003 |
| `95b01f25` | P-RC-7 P7.4 | refactor(agents/factory): retarget Agent + get_primary_agent imports to mclaw.agent.core | +2 / -2 (1 file, 2 imports) | 0 | ADR-0001, ADR-0003 |
| `f542e612` | P-RC-7 P7.5 | refactor(agents/orchestrator): retarget smart_truncate imports to mclaw.agent.tools | +2 / -2 (1 file, 2 imports) | 0 | ADR-0001, ADR-0003 |
| `23f8e05b` | P-RC-7 P7.6 | refactor(api+agent): retarget Agent + smart_truncate imports to mclaw.agent.* | +8 / -8 (8 files, 8 imports rewritten) | 0 | ADR-0001, ADR-0003 |
...
| `54faf9b4` | P-RC-7 P7.13 | refactor: migrate 47 remaining production shim imports (channels/evolution/scheduler/skills/tools.handlers) to `mclaw.agent.*` (and one cycle-safe rewrite via `_tool_executor_legacy`) | +47 / -47 (38 production files; 38 `Agent`, 6 `Brain`, 1 `save_overflow` set rewritten) | 0 | ADR-0001, ADR-0003 |
