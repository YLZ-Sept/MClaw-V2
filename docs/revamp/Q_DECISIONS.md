...
the Mclaw backend revamp, with the answer the operator
...
## Original full-backend revamp plan (``mclaw_full_backend_revamp_e6d8610d.plan.md``)
...
## Continuation plan (``mclaw_revamp_continuation_plan_d6192647.plan.md``) section 12
