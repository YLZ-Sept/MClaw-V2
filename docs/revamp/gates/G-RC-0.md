...
src/mclaw/plugins/manager.py src/mclaw/channels/gateway.py
...
---------------------------------------------------------------------------------
src/mclaw/core/agent.py                  9602      9602   9602      0  ok
src/mclaw/core/reasoning_engine.py       8725      8725   8725      0  ok
src/mclaw/core/brain.py                  2015      2015   2015      0  ok
src/mclaw/core/tool_executor.py          1818      1818   1818      0  ok
src/mclaw/core/context_manager.py        1799      1799   1799      0  ok
src/mclaw/orgs/runtime.py                6355      6355   6355      0  ok
src/mclaw/orgs/tool_handler.py           3474      3474   3474      0  ok
src/mclaw/orgs/templates.py              1266      1266   1266      0  ok
src/mclaw/orgs/messenger.py               651       651    651      0  ok
src/mclaw/agent/core.py                    68        58    108     40  ok
src/mclaw/agent/reasoning.py               61        51    101     40  ok
src/mclaw/agent/brain.py                   88        78    128     40  ok
src/mclaw/agent/tools.py                   66        56    106     40  ok
src/mclaw/agent/context.py                 57        47     97     40  ok
`
...
| file | change kind |
|---|---|
| `src/mclaw/config.py` | rewrite Runtime v2 comment block (commit 1) |
...
| `src/mclaw/agent/{core,reasoning,brain,tools,context}.py` | sentinel comment block (commit 5) |
