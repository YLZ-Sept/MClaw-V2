...
> surface (now includes ``src/mclaw/api/routes/`` whole-dir).
...
* **P3.4** ``SqliteOrgStore`` (``src/mclaw/runtime/orgs/sqlite_store.py``)
...
``src/mclaw/api/routes/`` directory. Two pre-existing nits
