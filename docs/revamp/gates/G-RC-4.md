...
> (now includes ``src/mclaw/runtime/llm/``,
> ``src/mclaw/runtime/io/``, ``src/mclaw/runtime/context/``,
...
|---|---:|---:|---:|
| ``src/mclaw/core/brain.py`` | 2015 | 26 | **-1989** (shim) |
| ``src/mclaw/core/tool_executor.py`` | 1818 | 41 | **-1777** (shim) |
| ``src/mclaw/core/context_manager.py`` | 1799 | 36 | **-1763** (shim) |
| ``src/mclaw/agent/brain.py`` | 88 | 370 | +282 (real impl) |
| ``src/mclaw/agent/tools.py`` | 56 | 347 | +291 (real impl) |
| ``src/mclaw/agent/context.py`` | 57 | 336 | +279 (real impl) |
...
* ``src/mclaw/agent/brain.py`` -- sentinel removed in P4.5;
* ``src/mclaw/agent/tools.py`` -- sentinel removed in P4.10;
* ``src/mclaw/agent/context.py`` -- sentinel removed in P4.14.

Two sentinels remain (legitimately):

* ``src/mclaw/agent/reasoning.py`` -- targeted at P-RC-5;
* ``src/mclaw/agent/core.py`` -- targeted at P-RC-6.
...
* The legacy ``core/_*_legacy.py`` modules are still on disk and
  ...
  carelessly imports ``mclaw.core.brain.<private>`` eagerly at
