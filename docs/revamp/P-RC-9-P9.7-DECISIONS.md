...
``src/mclaw/api/schemas/orgs_v2/*.py``, not inline
...
**No changes ship this turn.** ``src/mclaw/api/schemas/``
...
Evidence from ``src/mclaw/api/routes/orgs.py``
...
diff 096a5571..HEAD -- src/mclaw/ tests/ apps/``
