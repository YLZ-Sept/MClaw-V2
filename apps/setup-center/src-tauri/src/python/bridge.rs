...
#[tauri::command]
pub(crate) async fn mclaw_list_providers(venv_dir: String) -> Result<String, String> {
    spawn_blocking_result(move || {
        run_python_module_json(
            &venv_dir,
            "mclaw.setup_center.bridge",
            &["list-providers"],
            &[],
        )
    })
...
#[tauri::command]
pub(crate) async fn mclaw_list_skills(
    venv_dir: String,
    workspace_id: String,
) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn mclaw_list_models(
    venv_dir: String,
    api_type: String,
    base_url: String,
...
#[tauri::command]
pub(crate) async fn mclaw_version(venv_dir: String) -> Result<String, String> {
    spawn_blocking_result(move || {
        ...
        c.args([
            "-c",
            "import mclaw; print(getattr(mclaw,'__version__',''))",
        ]);
        let out = c
            .output()
            .map_err(|e| format!("get mclaw version failed: {e}"))?;
        if !out.status.success() {
            let stderr = String::from_utf8_lossy(&out.stderr).to_string();
            let stdout = String::from_utf8_lossy(&out.stdout).to_string();
            return Err(format!(
...
#[tauri::command]
pub(crate) async fn mclaw_health_check_endpoint(
    venv_dir: String,
    workspace_id: String,
    ...
    spawn_blocking_result(move || {
        ...
        run_python_module_json(&venv_dir, "mclaw.setup_center.bridge", &args, &[])
    })
    .await
}
...
/// Returns JSON array of health results.
#[tauri::command]
pub(crate) async fn mclaw_health_check_im(
    venv_dir: String,
    workspace_id: String,
...
#[tauri::command]
pub(crate) async fn mclaw_ensure_channel_deps(
    venv_dir: String,
    workspace_id: String,
) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn mclaw_install_skill(
    venv_dir: String,
    workspace_id: String,
    url: String,
) -> Result<String, String> {
...
#[tauri::command]
pub(crate) async fn mclaw_uninstall_skill(
    venv_dir: String,
    workspace_id: String,
    skill_name: String,
) -> Result<String, String> {
...
#[tauri::command]
pub(crate) async fn mclaw_list_marketplace(venv_dir: String) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn mclaw_get_skill_config(
    venv_dir: String,
    workspace_id: String,
    skill_name: String,
) -> Result<String, String> {
...
#[tauri::command]
pub(crate) async fn mclaw_wecom_onboard_start(venv_dir: String) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn mclaw_wecom_onboard_poll(
    venv_dir: String,
    scode: String,
) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn mclaw_feishu_onboard_start(
    venv_dir: String,
...
#[tauri::command]
pub(crate) async fn mclaw_feishu_onboard_poll(
    venv_dir: String,
    domain: Option<String>,
    device_code: String,
) -> Result<String, String> {
...
#[tauri::command]
pub(crate) async fn mclaw_feishu_validate(
    venv_dir: String,
    app_id: String,
    app_secret: String,
    domain: Option<String>,
...
#[tauri::command]
pub(crate) async fn mclaw_qqbot_onboard_start(venv_dir: String) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn mclaw_qqbot_onboard_poll(
    venv_dir: String,
    session_id: String,
) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn mclaw_qqbot_onboard_create(venv_dir: String) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn mclaw_qqbot_onboard_poll_and_create(
    venv_dir: String,
    session_id: String,
) -> Result<String, String> {
    spawn_blocking_result(move || {
...
/// Returns JSON with {valid: bool, error?: string}.
#[tauri::command]
pub(crate) async fn mclaw_qqbot_validate(
    venv_dir: String,
    app_id: String,
    app_secret: String,
) -> Result<String, String> {
...
#[tauri::command]
pub(crate) async fn mclaw_wechat_onboard_start(venv_dir: String) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn mclaw_wechat_onboard_poll(
    venv_dir: String,
    qrcode: String,
) -> Result<String, String> {
    spawn_blocking_result(move || {
