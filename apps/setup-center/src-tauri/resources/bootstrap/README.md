...
```text
~/.mclaw/runtime/app-venv
~/.mclaw/runtime/agent-venv
```
...
- `wheels/mclaw-<version>-py3-none-any.whl`: Mclaw wheel for app runtime.
...
The Python seed is a slim standalone interpreter, not a preinstalled Mclaw
