...
/** SSE stream event union — synced with Python mclaw.events / src/streamEvents.ts */
export type StreamEvent =
  ...
  // 后端 schema 见 src/mclaw/core/tool_executor.py:_emit_tool_intent_previews
  ...
  // Backend shape: src/mclaw/core/reasoning_engine.py:_build_tool_end_events.
