...
export type ViewId = "wizard" | "status" | "chat" | "skills" | "im" | "onboarding" | "token_stats" | "skill_usage" | "mcp" | "scheduler" | "memory" | "knowledge" | "dashboard" | "agent_manager" | "agent_store" | "skill_store" | "org_editor" | "pixel_office" | "digital_employee" | "identity" | "docs" | "security" | "pending_approvals" | "plugins" | "my_feedback" | `plugin_app:${string}`;
 ...
 * src/mclaw/core/reasoning_engine.py:_build_tool_end_events).
 *
