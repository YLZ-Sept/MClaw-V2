...
const GITHUB_REPO = "mclaw/mclaw";
const SKIPPED_RELEASE_KEY = "mclaw_release_skipped";
const LEGACY_DISMISSED_RELEASE_KEY = "mclaw_release_dismissed";
const REMIND_LATER_RELEASE_KEY = "mclaw_release_remind_later_session";
