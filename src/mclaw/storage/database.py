...
.. deprecated::
    ...
    pipe their connections through :mod:`mclaw.storage.safe_sqlite`.
...
class Database:
    ...
    def __init__(self, db_path: Path | None = None):
        warnings.warn(
            "mclaw.storage.database.Database is legacy; use a subsystem-"
            "specific store routed through mclaw.storage.safe_sqlite instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    async def connect(self) -> None:
        ...
        Raises :class:`mclaw.storage.safe_sqlite.SQLiteUnavailable`
