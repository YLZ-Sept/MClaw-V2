"""Mclaw v2 runtime package.

Layered orchestration core that replaces ``src/mclaw/orgs/`` per ADR-0002.

Public surface lives in :mod:`mclaw.runtime.facade` (added in Phase 6).
