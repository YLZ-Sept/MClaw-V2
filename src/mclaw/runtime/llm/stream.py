...
class _LLMClientLike(Protocol):
    """Structural subset of :class:`mclaw.llm.client.LLMClient` we need."""
...
async def llm_stream_tracking(
    *,
    ...
    """
    from mclaw.core.token_tracking import TokenTrackingContext
...
async def stream_llm_events(
    ...
    *,
    ...
    Args:
        ...
        messages: already-converted ``mclaw.llm.types.Message`` list.
