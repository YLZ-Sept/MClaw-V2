...
This module bridges the unified ``mclaw.llm.types`` block representation
...
``mclaw.agent.brain`` calls this module directly.
"""
...
def map_stop_reason(stop_reason: StopReason) -> str:
    """Project an :class:`mclaw.llm.types.StopReason` to the Anthropic string.
