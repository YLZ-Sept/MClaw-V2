"""Focused LLM runtime helpers composed by :mod:`mclaw.agent.brain`.
...
* :mod:`multimodal` -- pure conversions between ``mclaw.llm.types``
...
``mclaw.agent.brain`` composes these helpers around its private runtime base.
"""
