...
TEMPLATE_FACTORY_MARK = "__mclaw_template_factory__"
...
def discover_builtins(package: str = "mclaw.runtime.templates.builtin") -> int:
...
def collect_builtin_factories(
    package: str = "mclaw.runtime.templates.builtin",
