"""Shared :class:`~mclaw.runtime.supervisor.Supervisor` factory.
...
from mclaw.runtime.checkpoint import BaseCheckpointer, MemoryCheckpointer
from mclaw.runtime.stream import StreamBus
from mclaw.runtime.stream_registry import get_or_create_org_stream_bus
...
def get_or_create_checkpointer(
    ...
    *,
    ...
    with _CHECKPOINTER_LOCK:
        ...
        from mclaw.runtime.backends.sqlite import SqliteCheckpointer
...
def _resolve_speaker_to_node_id(
    ...
    *,
    ...
    if not node_directory:
        return raw
    try:
        from mclaw.runtime.llm_supervisor_brain import LLMSupervisorBrain
