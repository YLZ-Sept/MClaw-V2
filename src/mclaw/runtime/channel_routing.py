...
:func:`mclaw.runtime.state_graph.compile_from_org`.
...
from mclaw.orgs import OrgNotFound, get_default_store
from mclaw.runtime.models import NodeV2, OrgV2
from mclaw.runtime.state_graph import StateGraph, compile_from_org
...
def route_inbound_message_to_v2(*, org_id: str | None) -> RoutingPlan:
    ...
    try:
        ...
        # manager-backed shim (see ``src/mclaw/orgs/store.py``);
    ...
    *,
    ...
    Keyword Args:
        ...
        brain: optional :class:`SupervisorBrain`; defaults to the
            degenerate one in :mod:`mclaw.agent.supervisor_brain`.
    ...
    try:
        ...
        from mclaw.agent.supervisor_brain import default_supervisor_brain
        from mclaw.runtime.cancel_token import CancellationToken
        from mclaw.runtime.checkpoint import MemoryCheckpointer
        from mclaw.runtime.messenger import InMemoryNodeRegistry, Messenger
        from mclaw.runtime.stream import StreamBus
        from mclaw.runtime.supervisor import FinalOutcome
        from mclaw.runtime.supervisor_factory import build_supervisor_for_command
