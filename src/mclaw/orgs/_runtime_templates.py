...
* From v1 ``mclaw.orgs.tool_categories``:
...
1. ``_auto_assign_avatars`` drops its v1 deferred ``from
   mclaw.orgs.tool_categories import get_avatar_for_role`` line
   because the function now lives in the same module.
2. ``_auto_assign_agent_profiles`` reroutes its v1 deferred ``from
   mclaw.orgs.models import infer_agent_profile_id_for_node``
...
# ===========================================================================
# Avatar presets (v1 ``mclaw.orgs.tool_categories`` excerpt)
# ===========================================================================
...
# ===========================================================================
# Org templates (v1 ``mclaw.orgs.templates`` excerpt)
# ===========================================================================
...
# ===========================================================================
# Workbench templates (v1 ``mclaw.orgs.plugin_workbench_templates`` excerpt)
# ===========================================================================
