...
from mclaw.memory.types import normalize_tags
from mclaw.runtime.models import (
    DefaultsSpec,
    EdgeKind,
    EdgeV2,
...
class OrgNameConflictError(ValueError):
    ...
    v2 alias for v1 ``mclaw.orgs.manager.OrgNameConflictError``;
...
def get_org_manager(data_dir: Path) -> OrgManager:
    ...
    ``mclaw.orgs.manager.OrgManager`` factory pattern.
    """
