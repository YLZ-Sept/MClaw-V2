...
def _configure_launch() -> dict:
    ...
    try:
        from mclaw.plugins import sdk  # type: ignore  # noqa: F401
...
async def render_markdown_to_pdf(
    *,
    ...
    footer_html = _FOOTER_TEMPLATE.format(note=_html.escape(footer_note or "Mclaw 组织编排"))
    try:
