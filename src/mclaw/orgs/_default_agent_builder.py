...
from mclaw.runtime.execution_context import UpstreamContext, current_upstream_context_var
...
_NODE_SYSTEM_PREFIX = "[mclaw orgs_v2 node agent]"
...
class _BrainBackedNodeAgent:
    ...
    handler in :data:`mclaw.tools.handlers.default_handler_registry`,
    ...
    async def _run_no_tools_streaming(
        ...
        *,
        ...
        try:
            from mclaw.core.stream_accumulator import StreamAccumulator
    ...
    def _record_stream_usage(self, acc: Any) -> None:
        ...
        try:
            ...
            if not callable(record):
                return
            from mclaw.llm.types import Usage
