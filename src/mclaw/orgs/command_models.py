...
Duplicates v1 ``mclaw.orgs.command_service`` data classes
under the v2 namespace so ``runtime/orgs/command_service.py``
has zero ``mclaw.orgs.*`` imports (P-RC-9-PLAN section
...
class OrgCommandError(Exception):
    ...
    Mirrors v1 ``mclaw.orgs.command_service.OrgCommandError`` --
