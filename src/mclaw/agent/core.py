...
runtime base. Callers must import it from :mod:`mclaw.agent`; modules under
``mclaw.core._*_runtime`` are private implementation details.
"""
...
from mclaw.core.risk_intent import RiskIntentResult
from mclaw.runtime.desktop.attachments import (
    format_desktop_attachment_reference,
    maybe_inline_local_image,
)
from mclaw.runtime.state_graph import END, START, StateGraph
...
class Agent(_RuntimeAgentBase):
    ...
    def classify_inbound_risk(self, message: str, intent: Any = None) -> RiskIntentResult:
        ...
        Thin wrapper over
        :func:`mclaw.agent.safety.destructive_intent.classify_risk_intent`
    ...
    def format_attachment_reference(
        ...
        *,
        ...
        Routes through
        :func:`mclaw.runtime.desktop.attachments.format_desktop_attachment_reference`
    ...
    def inline_local_image_if_eligible(self, att_url: str, att_mime: str) -> str | None:
        ...
        Routes through
        :func:`mclaw.runtime.desktop.attachments.maybe_inline_local_image`.
        """
