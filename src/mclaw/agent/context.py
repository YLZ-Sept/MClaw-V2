...
budgeting, compression, and sanitization helpers from ``mclaw.runtime``.
"""
...
from mclaw.core._context_runtime import (
...
from mclaw.core.context_utils import (
...
from mclaw.runtime.context import (
    calc_context_budget,
    group_messages,
    payload_size_bytes,
    pre_request_cleanup,
