...
# D:/Mclaw/data``), the previous summary -- a sentence-break +
...
def consume_risk_authorization(session: Any, message: str) -> bool:
    ...
    if isinstance(intent_data, dict):
        try:
            from mclaw.core.risk_intent import AuthorizedIntent
...
def check_trust_mode_skip(risk_intent: RiskIntentResult | None) -> str | None:
    ...
    try:
        from mclaw.core.policy_v2 import ConfirmationMode
