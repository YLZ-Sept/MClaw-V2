...
The public class composes focused helpers from :mod:`mclaw.runtime.llm`
...
from mclaw.core._brain_runtime import Brain as _RuntimeBrainBase
from mclaw.core._brain_runtime import Context as _RuntimeContext
from mclaw.core._brain_runtime import Response as _RuntimeResponse
from mclaw.runtime.llm import (
...
class SupervisorBrain(Protocol):
    ...
    :class:`mclaw.runtime.state_graph.StateGraph` step. The
...
class Brain(_RuntimeBrainBase):
    ...
    * explicit :class:`SupervisorBrain` protocol conformance with the
    ...
    def llm_client(self) -> Any:
        """Return the borrowed :class:`mclaw.llm.client.LLMClient`.
