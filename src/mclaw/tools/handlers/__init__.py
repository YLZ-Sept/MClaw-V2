...
if TYPE_CHECKING:
    from mclaw.core.policy_v2 import ApprovalClass, DecisionSource, ToolPolicy
    from mclaw.tools.tool_guidance import ToolGuidance
...
class SystemHandlerRegistry:
    ...
    def _collect_tool_classes(
        ...
        from mclaw.core.policy_v2 import DecisionSource, most_strict
    ...
    def _collect_tool_policies(self, handler: HandlerFunc, tool_names: list[str]) -> None:
        ...
        from mclaw.core.policy_v2.context import _coerce_tool_policies
    ...
    def _collect_tool_guidance(self, handler: HandlerFunc, tool_names: list[str]) -> None:
        ...
        from mclaw.tools.tool_guidance import ToolGuidance, coerce_tool_guidance
