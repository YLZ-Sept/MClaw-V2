...
class ShellTool:
    ...
    async def pip_install(self, package: str) -> CommandResult:
        ...
        if spec is not None:
            try:
                from mclaw.runtime_manager import ensure_execution_env, get_pip_install_args
            ...
            from mclaw.runtime_manager import get_agent_pip_command
