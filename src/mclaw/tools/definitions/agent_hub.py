...
提供与 Mclaw Platform Agent Store 交互的工具：
...
AGENT_HUB_TOOLS = [
    {
        ...
        "category": "Agent Hub",
        "description": "Search for Agents on the Mclaw Platform Agent Store. Returns a list of available Agents with name, description, rating, and download count.",
        "input_schema": {
            "type": "object",
            "properties": {
                "query": {
    ...
    },
    {
        ...
        "category": "Agent Hub",
        "description": "Download and install an Agent from the Mclaw Platform Agent Store. Downloads the .akita-agent package and runs the local installer.",
        "input_schema": {
            "type": "object",
            "properties": {
                "agent_id": {
    ...
    },
    {
        "name": "publish_agent",
        "category": "Agent Hub",
        "description": "Publish a local Agent to the Mclaw Platform Agent Store. The Agent is first exported as a .akita-agent package, then uploaded.",
        "input_schema": {
            "type": "object",
            "properties": {
                "profile_id": {
    ...
    },
    {
        ...
        "category": "Agent Hub",
        "description": "Get detailed information about a specific Agent on the Mclaw Platform, including versions, ratings, and readme.",
        "input_schema": {
            "type": "object",
            "properties": {
                "agent_id": {
