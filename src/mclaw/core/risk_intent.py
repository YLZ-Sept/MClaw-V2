...
#
# 来源：
#   - mclaw/orgs/runtime.py::_format_incoming_message  (13 种 [收到xxx])
#   - mclaw/orgs/runtime.py::_push_summary_command_to_root ([用户指令最终汇总])
#   - mclaw/core/_reasoning_runtime.py 多处自注入  ([系统] / [系统提示])
#   - mclaw/core/_agent_runtime.py::_prepare_session_context  ([以上是之前的对话历史)
...
# decided to grep the entire ``~/.mclaw`` tree to "find" what to delete
