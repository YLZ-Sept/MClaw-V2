...
from mclaw.agent.loop_budget import READONLY_EXPLORATION_TOOLS, LoopBudgetGuard
from mclaw.agent.resource_budget import (
    BudgetAction,
    ResourceBudget,
...
from mclaw.runtime.state_graph.guards._text_patterns import (  # noqa: E402
...
# re-exported here under the previous private names for backward compat.
from mclaw.runtime.state_graph.guards.conversation_state import (
...
from mclaw.runtime.state_graph.guards.recap_context import (  # noqa: E402
...
# re-exported here under the previous private name for backward compat.
from mclaw.runtime.state_graph.guards.source_tag import (  # noqa: E402
...
# Extracted to runtime/state_graph/guards/tool_failure_ack.py (P-RC-5 P5.3);
# re-exported here under the previous private name for backward compat.
from mclaw.runtime.state_graph.guards.tool_failure_ack import (  # noqa: E402
    check_tool_failure_acknowledgement as _check_tool_failure_acknowledgement,
)

# Extracted to runtime/state_graph/guards/tool_failure_ack.py (P-RC-5 P5.3);
# re-exported here under the previous private name for backward compat.
from mclaw.runtime.state_graph.guards.unbacked_action import (  # noqa: E402
    action_claim_re as _get_action_claim_re,
)
from mclaw.runtime.state_graph.guards.unbacked_action import (
...
class ReasoningEngine:
    ...
    def _build_org_validation_kwargs(self) -> dict[str, object]:
        ...
        try:
            ...
            from mclaw.orgs.runtime import get_runtime  # 延迟导入避免环路
...
# mclaw.core._reasoning_runtime.<_private_name>.
from mclaw.runtime.state_graph.guards._verb_tool_map import (
...
from mclaw.runtime.state_graph.guards.recap_context import (
    is_recap_context as _is_recap_context,  # noqa: F401
)
from mclaw.runtime.state_graph.guards.tool_failure_ack import (
    successful_tool_names as _successful_tool_names,  # noqa: F401
)
from mclaw.runtime.state_graph.guards.tool_filters import (
