"""Mclaw built-in safety_immune paths (9 semantic categories).
...
- We want Mclaw's own identity files / audit trails / scheduler state
...
6. **User credentials / keys** — SSH/GPG/AWS/cloud creds + LLM endpoint
   keys + Mclaw's own user manager profiles.
