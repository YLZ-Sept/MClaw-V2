...
SHELL_TESTS = [
    ...
    TestCase(
        ...
        subcategory="shell",
        description="创建临时文件",
        input={"command": "touch /tmp/test_mclaw.txt && echo success"},
        expected="success",
        tags=["shell", "file"],
    ),
    TestCase(
        ...
        description="写入文件",
        input={
            "command": "echo 'test content' > /tmp/test_mclaw.txt && cat /tmp/test_mclaw.txt"
        },
    ...
    TestCase(
        ...
        description="追加文件",
        input={
            "command": "echo 'appended' >> /tmp/test_mclaw.txt && tail -1 /tmp/test_mclaw.txt"
        },
