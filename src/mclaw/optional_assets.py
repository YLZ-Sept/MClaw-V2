"""Resolve accelerated download sources for optional Mclaw features.

The public manifest is deliberately declarative: it may select a mirror for a
locally-known installer strategy, but it cannot supply commands for Mclaw
...
DEFAULT_OPTIONAL_ASSET_MANIFEST = "https://dl-mclaw.fzstack.com/api/optional-assets.json"
...
def _fetch_manifest(url: str) -> dict:
    request = urllib.request.Request(
        url,
        headers={"Accept": "application/json", "User-Agent": "Mclaw optional-assets"},
    )
