...
class SkillParser:
    ...
    def _build_metadata(self, data: dict, path: Path, body: str = "") -> SkillMetadata:
        ...
        # Extract metadata.mclaw structured fields
        raw_metadata = data.get("metadata", {})
        akita_meta = raw_metadata.get("mclaw", {}) if isinstance(raw_metadata, dict) else {}
    ...
    def validate(self, skill: ParsedSkill) -> list[str]:
        ...
        # metadata names identify the upstream skill, while Mclaw uses the
