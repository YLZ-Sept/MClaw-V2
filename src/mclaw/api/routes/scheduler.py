...
from mclaw.scheduler.delivery import is_im_delivery_channel
...
from mclaw.scheduler._naming import (
    FORBIDDEN_TOKENS as _TASK_NAME_FORBIDDEN,  # noqa: F401  (保持向后兼容导入)
)
from mclaw.scheduler._naming import validate_task_name as _validate_task_name  # noqa: E402
...
async def update_task(request: Request, task_id: str, body: TaskUpdateRequest):
    ...
    if body.task_type is not None:
        from mclaw.scheduler.task import TaskType
