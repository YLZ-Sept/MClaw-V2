...
This route module exposes the new :mod:`mclaw.runtime` stack
...
Persistence layer: :mod:`mclaw.orgs` (JSON file under
...
from mclaw.orgs.manager import OrgManager, OrgNameConflictError
from mclaw.orgs.org_models import EdgeType, OrgStatus
from mclaw.orgs.store import JsonOrgStore
from mclaw.runtime.models import EdgeKind, OrgV2
from mclaw.runtime.templates import (
    GLOBAL_REGISTRY,
...
# ``src/mclaw/orgs/store.py`` module docstring for the full
# contract.
...
def _resolve_manager_for_writes() -> OrgManager:
    ...
    from mclaw.orgs.store import _build_default_manager
