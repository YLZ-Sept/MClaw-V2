...
This shim is scheduled for removal in Mclaw 2.1.0. Only one route
...
* All eight remaining shim routes
  ...
  :func:`mclaw.api.server.create_app`. Their handlers exist in
...
def _redirect(target_path: str, request: Request) -> Response:
    ...
    the upcoming removal in Mclaw 2.1.0 (RCA v11 §3).
