...
from mclaw.api.schemas import ChatAttachmentRecord
...
def _history_entry(session, conversation_id: str, original_idx: int, msg: dict) -> dict:
    ...
    # bloat sessions.json. See mclaw.api.message_parts.
    from mclaw.api.message_parts import (
        build_message_parts,
        normalize_chat_todo,
...
async def generate_title(request: Request, body: GenerateTitleRequest):
    ...
    try:
        ...
        from mclaw.core.response_handler import strip_thinking_tags
