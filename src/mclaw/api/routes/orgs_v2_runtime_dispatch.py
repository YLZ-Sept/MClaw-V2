...
from mclaw.api.schemas.orgs_v2 import CancelRequest, CommandSubmit
...
async def send_command(request: Request, org_id: str, body: CommandSubmit) -> dict[str, Any]:
    ...
    if coerced:
        try:
            from mclaw.api.routes.chat import _enrich_org_content_with_attachments
