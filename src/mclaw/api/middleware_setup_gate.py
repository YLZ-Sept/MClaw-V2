...
When Mclaw is reachable on the LAN but no web-access password has been
...
Decision delegated to :mod:`mclaw.api.setup_state`. This module only
...
:func:`mclaw.api.auth.create_auth_middleware`. With FastAPI's LIFO
