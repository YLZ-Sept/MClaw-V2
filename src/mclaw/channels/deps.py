...
被以下模块引用:
- mclaw.main (_ensure_channel_deps)
- mclaw.setup.wizard (_check_channel_deps)
- mclaw.setup_center.bridge (ensure-channel-deps)
"""
...
# 通道名 → pyproject.toml extras 名称（用于 pip install mclaw[xxx] 提示）
